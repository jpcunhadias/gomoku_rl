...
def get_config() -> SimpleNamespace:
    """
    Sweep point: dirichlet_epsilon/epsilon_root x0.75, tau at v4 (unscaled), c_puct fixed.
    ...
    return SimpleNamespace(
        ...
        tau_cutoff_plies=3,
        tau_early=0.15,
        tau_early_plies={0: 0.78, 1: 0.46, 2: 0.28},  # v4, unscaled (this axis's center)
        add_dirichlet_noise=True,
        dirichlet_epsilon=0.075,  # v4 x0.75
        dirichlet_epsilon_root=0.375,  # v4 x0.75
